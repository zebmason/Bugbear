...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
//
// Forked by zebmason to make public methods virtual
//
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
namespace Gremlin.Net.Process.Traversal
{
    ...
    public class GraphTraversal<S, E> : DefaultTraversal<S, E>
    {
        ...
        /// </summary>
        virtual public GraphTraversal<S, Vertex> V (params object[] vertexIdsOrElements)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, Edge> AddE (string edgeLabel)
        {
        ...
        ///     Adds the addE step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, Edge> AddE (ITraversal edgeLabelTraversal)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, Vertex> AddV ()
        {
        ...
        ///     Adds the addV step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, Vertex> AddV (string vertexLabel)
        {
        ...
        ///     Adds the addV step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, Vertex> AddV (ITraversal vertexLabelTraversal)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> Aggregate (Scope scope, string sideEffectKey)
        {
        ...
        ///     Adds the aggregate step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> Aggregate (string sideEffectKey)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> And (params ITraversal[] andTraversals)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> As (string stepLabel, params string[] stepLabels)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> Barrier ()
        {
        ...
        ///     Adds the barrier step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> Barrier (IConsumer barrierConsumer)
        {
        ...
        ///     Adds the barrier step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> Barrier (int maxBarrierSize)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, Vertex> Both (params string[] edgeLabels)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, Edge> BothE (params string[] edgeLabels)
        {
            var args = new List<object>(0 + edgeLabels.Length) {};
            args.AddRange(edgeLabels);
        ...
        /// </summary>
        virtual public GraphTraversal<S, Vertex> BothV ()
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E2> Branch<E2> (IFunction function)
        {
        ...
        ///     Adds the branch step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E2> Branch<E2> (ITraversal branchTraversal)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> By ()
        {
            Bytecode.AddStep("by");
            return Wrap<S, E>(this);
        }
        ...
        ///     Adds the by step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> By (IComparator comparator)
        {
        ...
        ///     Adds the by step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> By (IFunction function)
        {
        ...
        ///     Adds the by step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> By (IFunction function, IComparator comparator)
        {
        ...
        ///     Adds the by step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> By (Order order)
        {
        ...
        ///     Adds the by step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> By (string key)
        {
        ...
        ///     Adds the by step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> By (string key, IComparator comparator)
        {
        ...
        ///     Adds the by step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> By (T token)
        {
        ...
        ///     Adds the by step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> By (ITraversal traversal)
        {
        ...
        ///     Adds the by step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> By (ITraversal traversal, IComparator comparator)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E2> Cap<E2> (string sideEffectKey, params string[] sideEffectKeys)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E2> Choose<E2> (IFunction choiceFunction)
        {
        ...
        ///     Adds the choose step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E2> Choose<E2> (IPredicate choosePredicate, ITraversal trueChoice)
        {
        ...
        ///     Adds the choose step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E2> Choose<E2> (IPredicate choosePredicate, ITraversal trueChoice, ITraversal falseChoice)
        {
        ...
        ///     Adds the choose step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E2> Choose<E2> (ITraversal choiceTraversal)
        {
        ...
        ///     Adds the choose step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E2> Choose<E2> (ITraversal traversalPredicate, ITraversal trueChoice)
        {
        ...
        ///     Adds the choose step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E2> Choose<E2> (ITraversal traversalPredicate, ITraversal trueChoice, ITraversal falseChoice)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E2> Coalesce<E2> (params ITraversal[] coalesceTraversals)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> Coin (double probability)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> ConnectedComponent ()
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E2> Constant<E2> (E2 e)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, long> Count ()
        {
        ...
        ///     Adds the count step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, long> Count (Scope scope)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> CyclicPath ()
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> Dedup (Scope scope, params string[] dedupLabels)
        {
        ...
        ///     Adds the dedup step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> Dedup (params string[] dedupLabels)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> Drop ()
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, IDictionary<object, E2>> ElementMap<E2> (params string[] propertyKeys)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> Emit ()
        {
        ...
        ///     Adds the emit step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> Emit (IPredicate emitPredicate)
        {
        ...
        ///     Adds the emit step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> Emit (ITraversal emitTraversal)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> Filter (IPredicate predicate)
        {
        ...
        ///     Adds the filter step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> Filter (ITraversal filterTraversal)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E2> FlatMap<E2> (IFunction function)
        {
        ...
        ///     Adds the flatMap step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E2> FlatMap<E2> (ITraversal flatMapTraversal)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, IList<E>> Fold ()
        {
        ...
        ///     Adds the fold step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E2> Fold<E2> (E2 seed, IBiFunction foldFunction)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> From (string fromStepLabel)
        {
        ...
        ///     Adds the from step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> From (ITraversal fromVertex)
        {
        ...
        ///     Adds the from step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> From (Vertex fromVertex)
        {
            Bytecode.AddStep("from", fromVertex);
            return Wrap<S, E>(this);
        }
        ...
        /// </summary>
        virtual public GraphTraversal<S, IDictionary<K, V>> Group<K, V> ()
        {
        ...
        ///     Adds the group step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> Group (string sideEffectKey)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, IDictionary<K, long>> GroupCount<K> ()
        {
        ...
        ///     Adds the groupCount step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> GroupCount (string sideEffectKey)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> Has (string propertyKey)
        {
        ...
        ///     Adds the has step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> Has (string propertyKey, object value)
        {
        ...
        ///     Adds the has step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> Has (string propertyKey, P predicate)
        {
        ...
        ///     Adds the has step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> Has (string label, string propertyKey, object value)
        {
        ...
        ///     Adds the has step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> Has (string label, string propertyKey, P predicate)
        {
        ...
        ///     Adds the has step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> Has (string propertyKey, ITraversal propertyTraversal)
        {
        ...
        ///     Adds the has step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> Has (T accessor, object value)
        {
        ...
        ///     Adds the has step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> Has (T accessor, P predicate)
        {
        ...
        ///     Adds the has step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> Has (T accessor, ITraversal propertyTraversal)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> HasId (object id, params object[] otherIds)
        {
        ...
        ///     Adds the hasId step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> HasId (P predicate)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> HasKey (P predicate)
        {
        ...
        ///     Adds the hasKey step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> HasKey (string label, params string[] otherLabels)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> HasLabel (P predicate)
        {
        ...
        ///     Adds the hasLabel step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> HasLabel (string label, params string[] otherLabels)
        {
            var args = new List<object>(1 + otherLabels.Length) {label};
            args.AddRange(otherLabels);
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> HasNot (string propertyKey)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> HasValue (object value, params object[] otherValues)
        {
        ...
        ///     Adds the hasValue step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> HasValue (P predicate)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, object> Id ()
        {
            Bytecode.AddStep("id");
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> Identity ()
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, Vertex> In (params string[] edgeLabels)
        {
            var args = new List<object>(0 + edgeLabels.Length) {};
            args.AddRange(edgeLabels);
        ...
        /// </summary>
        virtual public GraphTraversal<S, Edge> InE (params string[] edgeLabels)
        {
            var args = new List<object>(0 + edgeLabels.Length) {};
            args.AddRange(edgeLabels);
        ...
        /// </summary>
        virtual public GraphTraversal<S, Vertex> InV ()
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E2> Index<E2> ()
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> Inject (params E[] injections)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> Is (object value)
        {
        ...
        ///     Adds the is step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> Is (P predicate)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, string> Key ()
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, string> Label ()
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E2> Limit<E2> (Scope scope, long limit)
        {
        ...
        ///     Adds the limit step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E2> Limit<E2> (long limit)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E2> Local<E2> (ITraversal localTraversal)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, int> Loops ()
        {
        ...
        ///     Adds the loops step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, int> Loops (string loopName)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E2> Map<E2> (IFunction function)
        {
        ...
        ///     Adds the map step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E2> Map<E2> (ITraversal mapTraversal)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, IDictionary<string, E2>> Match<E2> (params ITraversal[] matchTraversals)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, double> Math (string expression)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E2> Max<E2> ()
        {
        ...
        ///     Adds the max step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E2> Max<E2> (Scope scope)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E2> Mean<E2> ()
        {
        ...
        ///     Adds the mean step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E2> Mean<E2> (Scope scope)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E2> Min<E2> ()
        {
        ...
        ///     Adds the min step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E2> Min<E2> (Scope scope)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> Not (ITraversal notTraversal)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> Option (object pickToken, ITraversal traversalOption)
        {
        ...
        ///     Adds the option step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> Option (ITraversal traversalOption)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E2> Optional<E2> (ITraversal optionalTraversal)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> Or (params ITraversal[] orTraversals)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> Order ()
        {
        ...
        ///     Adds the order step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> Order (Scope scope)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, Vertex> OtherV ()
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, Vertex> Out (params string[] edgeLabels)
        {
            var args = new List<object>(0 + edgeLabels.Length) {};
            args.AddRange(edgeLabels);
        ...
        /// </summary>
        virtual public GraphTraversal<S, Edge> OutE (params string[] edgeLabels)
        {
            var args = new List<object>(0 + edgeLabels.Length) {};
            args.AddRange(edgeLabels);
        ...
        /// </summary>
        virtual public GraphTraversal<S, Vertex> OutV ()
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> PageRank ()
        {
        ...
        ///     Adds the pageRank step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> PageRank (double alpha)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, Path> Path ()
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> PeerPressure ()
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E2> Profile<E2> ()
        {
        ...
        ///     Adds the profile step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> Profile (string sideEffectKey)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> Program (object vertexProgram)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, IDictionary<string, E2>> Project<E2> (string projectKey, params string[] otherProjectKeys)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E2> Properties<E2> (params string[] propertyKeys)
        {
            var args = new List<object>(0 + propertyKeys.Length) {};
            args.AddRange(propertyKeys);
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> Property (Cardinality cardinality, object key, object value, params object[] keyValues)
        {
        ...
        ///     Adds the property step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> Property (object key, object value, params object[] keyValues)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, IDictionary<string, E2>> PropertyMap<E2> (params string[] propertyKeys)
        {
            var args = new List<object>(0 + propertyKeys.Length) {};
            args.AddRange(propertyKeys);
        ...
        /// </summary>
        virtual public GraphTraversal<S, E2> Range<E2> (Scope scope, long low, long high)
        {
        ...
        ///     Adds the range step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E2> Range<E2> (long low, long high)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> Read ()
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> Repeat (string loopName, ITraversal repeatTraversal)
        {
        ...
        ///     Adds the repeat step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> Repeat (ITraversal repeatTraversal)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E2> Sack<E2> ()
        {
        ...
        ///     Adds the sack step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> Sack (IBiFunction sackOperator)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> Sample (Scope scope, int amountToSample)
        {
        ...
        ///     Adds the sample step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> Sample (int amountToSample)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, ICollection<E2>> Select<E2> (Column column)
        {
        ...
        ///     Adds the select step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E2> Select<E2> (Pop pop, string selectKey)
        {
        ...
        ///     Adds the select step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, IDictionary<string, E2>> Select<E2> (Pop pop, string selectKey1, string selectKey2, params string[] otherSelectKeys)
        {
        ...
        ///     Adds the select step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E2> Select<E2> (Pop pop, ITraversal keyTraversal)
        {
        ...
        ///     Adds the select step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E2> Select<E2> (string selectKey)
        {
        ...
        ///     Adds the select step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, IDictionary<string, E2>> Select<E2> (string selectKey1, string selectKey2, params string[] otherSelectKeys)
        {
        ...
        ///     Adds the select step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E2> Select<E2> (ITraversal keyTraversal)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, Path> ShortestPath ()
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> SideEffect (IConsumer consumer)
        {
        ...
        ///     Adds the sideEffect step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> SideEffect (ITraversal sideEffectTraversal)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> SimplePath ()
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E2> Skip<E2> (Scope scope, long skip)
        {
        ...
        ///     Adds the skip step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E2> Skip<E2> (long skip)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> Store (string sideEffectKey)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, Edge> Subgraph (string sideEffectKey)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E2> Sum<E2> ()
        {
        ...
        ///     Adds the sum step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E2> Sum<E2> (Scope scope)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E2> Tail<E2> ()
        {
        ...
        ///     Adds the tail step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E2> Tail<E2> (Scope scope)
        {
        ...
        ///     Adds the tail step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E2> Tail<E2> (Scope scope, long limit)
        {
        ...
        ///     Adds the tail step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E2> Tail<E2> (long limit)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> TimeLimit (long timeLimit)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> Times (int maxLoops)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, Vertex> To (Direction direction, params string[] edgeLabels)
        {
        ...
        ///     Adds the to step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> To (string toStepLabel)
        {
        ...
        ///     Adds the to step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> To (ITraversal toVertex)
        {
        ...
        ///     Adds the to step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> To (Vertex toVertex)
        {
            Bytecode.AddStep("to", toVertex);
            return Wrap<S, E>(this);
        }
        ...
        /// </summary>
        virtual public GraphTraversal<S, Edge> ToE (Direction direction, params string[] edgeLabels)
        {
            var args = new List<object>(1 + edgeLabels.Length) {direction};
            args.AddRange(edgeLabels);
        ...
        /// </summary>
        virtual public GraphTraversal<S, Vertex> ToV (Direction direction)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E2> Tree<E2> ()
        {
        ...
        ///     Adds the tree step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> Tree (string sideEffectKey)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E2> Unfold<E2> ()
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E2> Union<E2> (params ITraversal[] unionTraversals)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> Until (IPredicate untilPredicate)
        {
        ...
        ///     Adds the until step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> Until (ITraversal untilTraversal)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E2> Value<E2> ()
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, IDictionary<TKey, TValue>> ValueMap<TKey, TValue> (params string[] propertyKeys)
        {
            var args = new List<object>(0 + propertyKeys.Length) {};
            args.AddRange(propertyKeys);
        ...
        ///     Adds the valueMap step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, IDictionary<TKey, TValue>> ValueMap<TKey, TValue> (bool includeTokens, params string[] propertyKeys)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E2> Values<E2> (params string[] propertyKeys)
        {
            var args = new List<object>(0 + propertyKeys.Length) {};
            args.AddRange(propertyKeys);
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> Where (P predicate)
        {
        ...
        ///     Adds the where step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> Where (string startKey, P predicate)
        {
        ...
        ///     Adds the where step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> Where (ITraversal whereTraversal)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> With (string key)
        {
        ...
        ///     Adds the with step to this <see cref="GraphTraversal{SType, EType}" />.
        /// </summary>
        virtual public GraphTraversal<S, E> With (string key, object value)
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> Write ()
        {
        ...
        /// </summary>
        virtual public GraphTraversal<S, E> Clone()
        {
